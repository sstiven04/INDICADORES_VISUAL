...
bienestar = pd.read_csv('basebienestar2.csv')
bienestardf2 = gpd.read_file('basebienestar2.csv')



tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs(['Exploración Estadistica', 'Exploración gráfica', 'Pruebas de hipótesis', 'Análisis georreferenciado', 'Indicador', 'Creado por:'])
...
with tab1:
    ...
    resumen['Medias electricidad'] = bienestar.groupby(['años']).agg({'electricidad':'mean'})
